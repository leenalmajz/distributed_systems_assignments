...
def setup():
    # create user objects
    user1 = services_pb2.User(username='username1', password='password1')
...
def test_authenticating_user(objects):
    ...
    response_authenticate_true = auth_stub.Authenticate(services_pb2.AuthenticationMessage(
        username=objects['user1'].username, password=objects['user1'].password))
    ...
    response_authenticate_false = auth_stub.Authenticate(services_pb2.AuthenticationMessage(
        username=objects['user1'].username, password='notacorrectpassword'))
